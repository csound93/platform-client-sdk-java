...
| **callToAction** | <!----><!---->[**PatchCallToAction**](PatchCallToAction.md)<!---->                                         | Properties customizing the call to action button on the content offer.       | [optional] |
| **style**        | <!----><!---->[**PatchContentOfferStylingConfiguration**](PatchContentOfferStylingConfiguration.md)<!----> | Properties customizing the styling of the content offer.                     | [optional] |
